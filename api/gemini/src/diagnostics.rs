...
//! 
//! ```rust,ignore
//! use api_gemini::{ GenerateContentRequest, Content, Part, diagnostics::AsCurl };
//! 
...
//! 
//! ```rust,ignore
//! use api_gemini::{ EmbedContentRequest, Content, Part, diagnostics::{ AsCurl, CurlOptions } };
//! 
...
pub trait AsCurl
{
  ...
  /// 
  /// ```rust,ignore
  /// use api_gemini::diagnostics::{ AsCurl, CurlOptions };
  /// 
  /// let curl_command = request.as_curl_with_options( &CurlOptions::pretty() );
  /// ```
...
pub mod debug_helpers
{
  ...
  /// 
  /// ```rust,ignore
  /// use api_gemini::diagnostics::debug_helpers;
  /// 
  /// let curl_cmd = debug_helpers::simple_generate_curl( 
  ...
  /// 
  /// ```rust,ignore
  /// use api_gemini::diagnostics::{ debug_helpers, CurlOptions };
  /// 
  /// let curl_cmd = debug_helpers::simple_embed_curl( 
  ///   "Hello world", 
