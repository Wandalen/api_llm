...
impl Models
{
  /// Kimi K2 Instruct model (default for chat - works with new Router API)
  ///
  /// This is the recommended default model for the new `HuggingFace` Router API.
  /// Provides excellent reasoning capabilities and math performance.
  #[ inline ]
  #[ must_use ]
